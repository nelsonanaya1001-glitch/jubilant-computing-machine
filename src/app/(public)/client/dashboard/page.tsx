    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">Here's the status of your projects.</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm text-center py-16">
            ...
            <p className="text-gray-400 text-sm mb-6">Submit your website request to get started.</p>
                    ...
                    <div className="flex gap-2">
                      {["SUBMITTED", "DISCOVERY", "DESIGN", "DEVELOPMENT", "REVIEW", "COMPLETED"].map((s) => {
                        ...
                        return (
                          <div
                            key={s}
                            className={`flex-1 h-1.5 rounded-full ${thisIdx <= current ? "bg-blue-500" : "bg-gray-100"}`}
                          />
                        );
                      })}
                    </div>
